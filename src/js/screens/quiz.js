import { getQuizQuestionsByNodeId } from '../data/quiz.js';
...
export function openQuizExitModal(onConfirmLeave) {
  ...
  const handle = openConfirmModal({
    ...
    body: t('quiz.exitBody'),
    cancelLabel: t('quiz.exitCancel'),
 ...
 */
function isExactAnswerSet(selectedIds, correctIds) {
 ...
 * @param {ReadonlyArray<string>} correctIds
 */
function isExactAnswerOrder(selectedIds, correctIds) {
