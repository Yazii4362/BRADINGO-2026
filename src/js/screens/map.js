...
import { localizeNode, t } from '../i18n/index.js';
...
import { createCreatorPromoCard } from '../components/creator-promo.js';
...
export function renderMap(props) {
  ...
  cover.innerHTML = `
    <div class="cb-map-cover__profile">
      <img
        ...
        src="./assets/images/map/profile-end.webp"
  ...
  /** Desktop/tablet: under 브래디의 UOS LIFE. Mobile: after map path (one scroll). */
