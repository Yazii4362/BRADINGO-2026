...
const MESSAGES = {
  ko: {
    ...
    'quiz.n1.q3.question': '들은 내용을 탭하세요',
    'quiz.n1.q3.characterAlt': '병건이 캐릭터',
    'quiz.n1.q3.listenText': '병건아 졸업을 축하해',
    'quiz.n1.q3.token.byeong': '병건아',
    'quiz.n1.q3.token.jol': '졸업을',
    'quiz.n1.q3.token.chuk': '축하해',
    'quiz.n1.q3.token.ip': '입학을',
    'quiz.n1.q3.token.grad': '대학원',
    'quiz.n1.q3.token.an': '안',
    'quiz.n1.q3.token.cham': '참',
    'quiz.n1.q3.feedback.correct.title': '정답입니다!',
    'quiz.n1.q3.feedback.correct.body': '병건아, 졸업을 축하해!',
    'quiz.n1.q3.feedback.incorrect.title': '오답입니다!',
    'quiz.n1.q3.feedback.incorrect.body': '정답은 「병건아 졸업을 축하해」예요.',

    'quiz.n1.q4.question': '누가 병건이 졸업을 축하하러 왔나요?',
    'quiz.n1.q4.instruction': '해당하는 답을 모두 선택하세요.',
    'quiz.n1.q4.choice.dabin.label': '이다빈',
    'quiz.n1.q4.choice.dabin.alt': '이다빈',
    'quiz.n1.q4.choice.yaji.label': '야지',
    'quiz.n1.q4.choice.yaji.alt': '야지',
    'quiz.n1.q4.choice.yubinu.label': '유비누',
    'quiz.n1.q4.choice.yubinu.alt': '유비누',
    'quiz.n1.q4.choice.gaeuni.label': '가으니',
    'quiz.n1.q4.choice.gaeuni.alt': '가으니',
    'quiz.n1.q4.feedback.correct.title': '정답입니다!',
    'quiz.n1.q4.feedback.correct.body': '병건이의 졸업을 축하하려고 친구들이 모두 모였어요.',
    'quiz.n1.q4.feedback.incorrect.title': '오답입니다!',
    'quiz.n1.q4.feedback.incorrect.body': '병건이를 축하하러 온 친구 네 명을 모두 선택해 주세요.',
  ...
  en: {
    ...
    'quiz.n1.q3.question': 'Tap what you hear',
    'quiz.n1.q3.characterAlt': 'Byeonggeon character',
    'quiz.n1.q3.listenText': 'Byeonggeon, congrats on graduating',
    'quiz.n1.q3.token.byeong': 'Byeonggeon,',
    'quiz.n1.q3.token.jol': 'congrats on',
    'quiz.n1.q3.token.chuk': 'graduating',
    'quiz.n1.q3.token.ip': 'enrolling',
    'quiz.n1.q3.token.grad': 'grad school',
    'quiz.n1.q3.token.an': 'not',
    'quiz.n1.q3.token.cham': 'really',
    'quiz.n1.q3.feedback.correct.title': 'Correct!',
    'quiz.n1.q3.feedback.correct.body': 'Byeonggeon, congrats on graduating!',
    'quiz.n1.q3.feedback.incorrect.title': 'Incorrect!',
    'quiz.n1.q3.feedback.incorrect.body': 'The answer is “Byeonggeon, congrats on graduating”.',

    'quiz.n1.q4.question': 'Who came to congratulate Byeonggeon on graduating?',
    'quiz.n1.q4.instruction': 'Select all that apply.',
    'quiz.n1.q4.choice.dabin.label': 'Dabin',
    'quiz.n1.q4.choice.dabin.alt': 'Dabin',
    'quiz.n1.q4.choice.yaji.label': 'Yaji',
    'quiz.n1.q4.choice.yaji.alt': 'Yaji',
    'quiz.n1.q4.choice.yubinu.label': 'Yubinu',
    'quiz.n1.q4.choice.yubinu.alt': 'Yubinu',
    'quiz.n1.q4.choice.gaeuni.label': 'Gaeuni',
    'quiz.n1.q4.choice.gaeuni.alt': 'Gaeuni',
    'quiz.n1.q4.feedback.correct.title': 'Correct!',
    'quiz.n1.q4.feedback.correct.body': 'All the friends gathered to celebrate Byeonggeon’s graduation.',
    'quiz.n1.q4.feedback.incorrect.title': 'Incorrect!',
    'quiz.n1.q4.feedback.incorrect.body': 'Please select all four friends who came to celebrate.',
  ...
  ja: {
    ...
    'quiz.n1.q3.question': '聞いた内容をタップしてください',
    'quiz.n1.q3.characterAlt': 'ビョンゴンキャラクター',
    'quiz.n1.q3.listenText': 'ビョンゴン 卒業おめでとう',
    'quiz.n1.q3.token.byeong': 'ビョンゴン',
    'quiz.n1.q3.token.jol': '卒業',
    'quiz.n1.q3.token.chuk': 'おめでとう',
    'quiz.n1.q3.token.ip': '入学を',
    'quiz.n1.q3.token.grad': '大学院',
    'quiz.n1.q3.token.an': 'しない',
    'quiz.n1.q3.token.cham': 'ほんと',
    'quiz.n1.q3.feedback.correct.title': '正解です！',
    'quiz.n1.q3.feedback.correct.body': 'ビョンゴン、卒業おめでとう！',
    'quiz.n1.q3.feedback.incorrect.title': '不正解です！',
    'quiz.n1.q3.feedback.incorrect.body': '正解は「ビョンゴン 卒業おめでとう」です。',

    'quiz.n1.q4.question': '誰がビョンゴンの卒業をお祝いに来たでしょう？',
    'quiz.n1.q4.instruction': '当てはまるものをすべて選んでください。',
    'quiz.n1.q4.choice.dabin.label': 'ダビン',
    'quiz.n1.q4.choice.dabin.alt': 'ダビン',
    'quiz.n1.q4.choice.yaji.label': 'ヤジ',
    'quiz.n1.q4.choice.yaji.alt': 'ヤジ',
    'quiz.n1.q4.choice.yubinu.label': 'ユビヌ',
    'quiz.n1.q4.choice.yubinu.alt': 'ユビヌ',
    'quiz.n1.q4.choice.gaeuni.label': 'ガウン',
    'quiz.n1.q4.choice.gaeuni.alt': 'ガウン',
    'quiz.n1.q4.feedback.correct.title': '正解です！',
    'quiz.n1.q4.feedback.correct.body': 'ビョンゴンの卒業をお祝いするために友達が全員集まりました。',
    'quiz.n1.q4.feedback.incorrect.title': '不正解です！',
    'quiz.n1.q4.feedback.incorrect.body': 'お祝いしに来た友達4人をすべて選んでください。',
  ...
  es: {
    ...
    'quiz.n1.q3.question': 'Toca lo que oyes',
    'quiz.n1.q3.characterAlt': 'Personaje de Byeonggeon',
    'quiz.n1.q3.listenText': 'Byeonggeon, felicidades por graduarte',
    'quiz.n1.q3.token.byeong': 'Byeonggeon,',
    'quiz.n1.q3.token.jol': 'felicidades por',
    'quiz.n1.q3.token.chuk': 'graduarte',
    'quiz.n1.q3.token.ip': 'matricularte',
    'quiz.n1.q3.token.grad': 'posgrado',
    'quiz.n1.q3.token.an': 'no',
    'quiz.n1.q3.token.cham': 'muy',
    'quiz.n1.q3.feedback.correct.title': '¡Correcto!',
    'quiz.n1.q3.feedback.correct.body': '¡Byeonggeon, felicidades por graduarte!',
    'quiz.n1.q3.feedback.incorrect.title': '¡Incorrecto!',
    'quiz.n1.q3.feedback.incorrect.body': 'La respuesta es “Byeonggeon, felicidades por graduarte”.',

    'quiz.n1.q4.question': '¿Quién vino a felicitar a Byeonggeon por graduarse?',
    'quiz.n1.q4.instruction': 'Selecciona todas las opciones correctas.',
    'quiz.n1.q4.choice.dabin.label': 'Dabin',
    'quiz.n1.q4.choice.dabin.alt': 'Dabin',
    'quiz.n1.q4.choice.yaji.label': 'Yaji',
    'quiz.n1.q4.choice.yaji.alt': 'Yaji',
    ...
    'quiz.n1.q4.choice.gaeuni.label': 'Gaeuni',
    'quiz.n1.q4.choice.gaeuni.alt': 'Gaeuni',
    'quiz.n1.q4.feedback.correct.title': '¡Correcto!',
    'quiz.n1.q4.feedback.correct.body': 'Todos los amigos se reunieron para celebrar la graduación de Byeonggeon.',
    'quiz.n1.q4.feedback.incorrect.title': '¡Incorrecto!',
    'quiz.n1.q4.feedback.incorrect.body': 'Selecciona a los cuatro amigos que vinieron a felicitarlo.',
