...
const MESSAGES = {
  ko: {
    ...
    'ending.stat.memoriesValue': '무한대',
    'ending.eggAria': '숨겨진 쿠폰',
    'ending.saveAria': '이미지로 저장',
  ...
  en: {
    ...
    'header.friendsDesc': 'Friends are unlimited. ∞',
    ...
    'ending.stat.memoriesValue': 'Unlimited',
    'ending.eggAria': 'Hidden coupon',
    'ending.saveAria': 'Save as image',
  ...
  ja: {
    ...
    'ending.stat.memoriesValue': 'むげん',
    'ending.eggAria': 'かくしクーポン',
    'ending.saveAria': '画像で保存',
  ...
  es: {
    ...
    'header.friendsDesc': 'Los amigos son ilimitados. ∞',
    ...
    'ending.stat.memoriesValue': 'Ilimitado',
    'ending.eggAria': 'Cupón oculto',
    'ending.saveAria': 'Guardar imagen',
