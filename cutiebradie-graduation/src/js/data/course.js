...
export const FRIENDS_FEED = Object.freeze({
  ...
  friends: Object.freeze([
    Object.freeze({
      ...
      preview: '브래디, 졸업 축하해! 🥳🎓',
      letter:
        '브래디, 졸업을 축하해!\n\n함께한 캠퍼스 시간이 참 즐거웠어. 앞으로의 길도 응원할게.\n\n— Friend A',
    ...
    Object.freeze({
      ...
      email: '',
      group: 'Today',
      preview: '졸업 축하해. BRADINGO로 여정을 남겨봤어.',
      letter:
        '브래디, 졸업 축하해!\n\n이 데모는 실제 편지 대신 더미 문구를 넣었어.\n\n— Friend B',
    ...
    Object.freeze({
      ...
      email: '',
      group: 'Yesterday',
      preview: '졸업 축하해. 새로운 시작을 응원해!',
      letter:
        'To 브래디\n\n졸업 축하해. 앞으로 종종 즐거운 추억 많이 쌓자.\n\n— Friend D',
