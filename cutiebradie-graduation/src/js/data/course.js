...
export const MEMORY_CONTENTS = Object.freeze({
  n3: Object.freeze({
    ...
    memories: Object.freeze([
      ...
      Object.freeze({
        id: 'memory-37',
        image: './assets/images/memory/37-running.webp',
        alt: '트랙에서 엄지척 하는 찌쥬 달리기 모임',
        caption: '찌쥬 달리기',
        date: '2023',
        category: 'running',
      }),
      ...
      Object.freeze({
        id: 'memory-56',
        image: './assets/images/memory/56-snacks-2.webp',
        alt: '2퍼센트 복숭아와 피규어 간식 컷',
        caption: '2% 복숭아',
        date: '2026',
        category: '2025',
      }),
